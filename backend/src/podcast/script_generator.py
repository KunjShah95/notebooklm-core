...
class PodcastScriptGenerator:
    def __init__(self, api_key: str = None, provider: str = "groq", model_name: str = "llama3-8b-8192"):
        ...
        logger.info(f"Podcast script generator initialized with {self.full_model_name}")
...
if __name__ == "__main__":
    ...
    if provider == "groq" and not lightning_api_key:
        print("Please set LIGHTNING_API_KEY environment variable for Groq")
        exit(1)
    
    generator = PodcastScriptGenerator(lightning_api_key, provider, model_name)
